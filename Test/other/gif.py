...
class SimulationProcessor:
    ...
    def update_plot(self, num):
        """Update the plot with each new coordinate using blitting."""
        ...
        if hasattr(self, 'vacuum_coords_np'):
            ...
            if hasattr(self, 'vacuum_line') and self.vacuum_line:
                ...
                self.ax.draw_artist(self.vacuum_line)
            else:
            ...
            if self.show_travel:
                if hasattr(self, 'travel_line') and self.travel_line:
                    ...
                    self.ax.draw_artist(self.travel_line)
                else:
    ...
    def plot_toolpath_animation(self, e_coords_list, travel_coords_list, coordinates, interval):
        ...
        self.background = self.fig.canvas.copy_from_bbox(self.ax.bbox)  # Save the background
        plt.show()
